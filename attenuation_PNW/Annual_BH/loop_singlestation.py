...
# %%
inp_year=sys.argv[1]
data_path = f"/home/kffeng/DATA_PNW/pnw_{inp_year}/STACK_acfs_BH_{inp_year}/"
...
outdir="./"
fcsv=outdir+f"/OUTPUT_BH_{inp_year}.csv"
file = open(fcsv, "w")
...
fn_sta=outdir+f"/station_list_BH_{inp_year}.csv"
