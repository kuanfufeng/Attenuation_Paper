...
def main():
    ...
    net="NC"
    path = "/home/kffeng/DATA_CaSC/ncedc_data_2020-2022/"

    os.makedirs(path, exist_ok=True)
    cc_data_path = os.path.join(path, "ACFs_NC")
    stack_data_path = os.path.join(path, "STACK_acfs_NC")
    ...
    S3_DATA = "s3://ncedc-pds/continuous_waveforms/"+net+"/"
    ...
    # %%
    S3_STATION_XML = "s3://ncedc-pds/FDSNstationXML/"+net+"/"            # S3 storage of stationXML
    ...
    raw_store = NCEDCS3DataStore(S3_DATA, catalog, 
                                channel_filter(config.net_list, stations, ["HHE", "HHN", "HHZ", "BHE", "BHN", "BHZ"]), 
